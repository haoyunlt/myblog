...
class BlogPostProcessor:
    def __init__(self, posts_dir: str):
        ...
        self.tag_mapping = {
            ...
            'autogpt': ['AutoGPT', 'Python', 'AI智能体', '自动化'],
            'autogen': ['AutoGen', 'Python', '多智能体', '协作框架'],
            'openaiagent': ['OpenAI Agent', 'Python', 'AI智能体', 'GPT'],
            'qwenagent': ['QwenAgent', 'Python', '通义千问', 'AI智能体'],
            'githubmcpserver': ['GitHub', 'MCP', 'Protocol', '模型上下文协议'],
            'langgraph': ['LangGraph', 'Python', '状态图', 'AI工作流'],
            'langchain': ['LangChain', 'Python', 'AI框架', 'Chain'],
            'metagpt': ['MetaGPT', 'Python', '软件开发', '多角色协作'],
            'tensorrtllm': ['TensorRT-LLM', 'NVIDIA', 'GPU推理', '优化'],
            'golang': ['Go', '并发编程', '系统编程'],
            'tensorflow': ['TensorFlow', 'Python', '深度学习', '机器学习'],
            'grpc': ['gRPC', 'Protobuf', 'RPC', '微服务'],
            'kitex': ['Kitex', 'Go', 'RPC框架', '字节跳动'],
            'nginx': ['Nginx', 'Web服务器', '反向代理', '负载均衡'],
            'kafka': ['Kafka', 'Java', '消息队列', '流处理'],
            'flink': ['Flink', 'Java', '流计算', '实时处理'],
            'istio': ['Istio', '服务网格', 'Kubernetes', '微服务'],
            'mysql': ['MySQL', 'SQL', '关系数据库', 'InnoDB'],
            'clickhouse': ['ClickHouse', 'C++', '列式数据库', 'OLAP'],
            'rocksdb': ['RocksDB', 'C++', 'LSM-Tree', '存储引擎'],
            'leveldb': ['LevelDB', 'C++', '键值存储', 'Google'],
            'pgvector': ['pgvector', 'PostgreSQL', '向量数据库', 'AI'],
            'milvus': ['Milvus', '向量数据库', 'AI搜索', '机器学习'],
            'minio': ['MinIO', 'Go', '对象存储', 'S3兼容'],
            'elasticsearch': ['Elasticsearch', 'Java', '搜索引擎', 'Lucene'],
            'netpoll': ['NetPoll', 'Go', '网络库', '字节跳动'],
            'openmanus': ['OpenManus', '机器人', '控制系统', '传感器'],
            'dify': ['Dify', 'Python', 'LLM应用', '低代码'],
            '语音助手': ['语音助手', '智能助手', '语音识别'],
            'voicehelper': ['VoiceHelper', '语音处理', 'WebRTC'],
            '聊天助手': ['聊天助手', '客服系统', '对话系统'],
            'etcd': ['etcd', 'Go', '分布式存储', 'Raft'],
        }
