...
### 1. [整体架构设计](./01-整体架构设计.md)
- 系统整体架构图
- 核心组件关系图
- 数据流时序图
- 模块交互图

### 2. [核心API详细分析](./02-核心API分析.md)
- 对外暴露的主要API
- API调用链路分析
- 关键函数实现剖析

### 3. [Agent模块深度解析](./03-Agent模块解析.md)
- Agent基类设计原理
- 具体Agent实现分析
- 消息处理机制
- 工具调用流程

### 4. [LLM模块架构分析](./04-LLM模块分析.md)
- BaseChatModel抽象设计
- 多种模型服务适配
- 函数调用机制
- 流式输出处理

### 5. [Tools工具系统解析](./05-Tools工具系统.md)
- 工具注册机制
- 内置工具详解
- 自定义工具开发
- 工具调用链路

### 6. [Memory内存管理](./06-Memory内存管理.md)
- 内存管理架构
- 文件处理机制
- RAG检索实现

### 7. [GUI界面系统](./07-GUI界面系统.md)
- WebUI架构设计
- Gradio集成方案
- 消息流处理

### 8. [多Agent协作机制](./08-多Agent协作.md)
- MultiAgentHub设计
- Agent间通信机制
- 协作模式分析

### 9. [数据结构与UML图](./09-数据结构UML.md)
- 核心数据结构设计
- UML类图详解
- 消息格式规范

### 10. [实战案例与最佳实践](./10-实战案例.md)
- 框架使用示例
- 自定义Agent开发
- 性能优化建议
- 问题排查指南
