...
description: "Kubernetes 源码剖析 - 03-Scheduler"
author: "源码分析"
weight: 500
ShowToc: true
TocOpen: true
...
1. PreBind    ──> 绑定前准备工作（如挂载远程存储）
2. Bind       ──> 调用 API Server 绑定 Pod
3. PostBind   ──> 绑定后清理工作（如记录指标）
